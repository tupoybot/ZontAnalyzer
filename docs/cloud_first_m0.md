...
изменение runtime. Лимиты, восстановление, журнал без payload и дополнительная
стоимость внешнего egress остаются предметом проверки; адреса и устройство
личной инфраструктуры в публичный контракт не входят.
