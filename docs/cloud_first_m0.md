...
Способ внесения записей и доступ к DNS ещё не проверены. Terraform управляет
облачными ресурсами и привязкой домена; автоматизация внешнего DNS пока не выбрана.
...
| Web/TLS/DNS | Владелец + исполнитель / выбор M0, spike M1 | Выбран отдельный тестовый поддомен с внешним DNS; способ внесения записей и доступ уточнить, DNS/TLS/auth проверить в M1 |
