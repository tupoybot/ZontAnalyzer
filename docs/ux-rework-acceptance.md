...
2026-09-07 владелец принял развёрнутый UX и разрешил слияние: «мерж».
Ветка `ux-rework` интегрирована в `main`. Исполняемый код соответствует
проверенному release `c2181fd`; повторный деплой для фиксации приёмки не требуется.
