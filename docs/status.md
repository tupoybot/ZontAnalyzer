...
- [Контракты и проверки M0](./cloud_first_m0.md), ветка `docs/cloud-first-m0`.
  ...
  пятиминутного сборщика. Используется существующий внешний proxy; прикладной маршрутизации
  достаточно, сетевая изоляция произвольного кода не требуется.
...
- Подготовлены карта данных/web API, storage/publisher/jobs/secrets контракты.
  ...
  Остались интерфейс подключения выбранного egress, bootstrap/state
