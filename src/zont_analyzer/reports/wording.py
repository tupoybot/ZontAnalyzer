...
_REPLACEMENTS: tuple[tuple[re.Pattern[str], str], ...] = (
    (re.compile(
        r"^При этом в тёплые часы отопление иногда автоматически переходило в летний режим"
        r" — это ожидаемая реакция настроенной автоматики, а не признак проблемы$", re.I,
